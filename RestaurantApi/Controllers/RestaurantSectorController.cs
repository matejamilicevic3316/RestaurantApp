...
namespace RestaurantApi.Controllers
{
    ...
    public class RestaurantSectorController : ControllerBase
    {
        ...
        [HttpGet]
        public ActionResult<IEnumerable<RestaurantSectorDTO>> Get([FromQuery] RestaurantSectorSearch search)
        {
            try
            {
        ...
        public ActionResult<RestaurantSectorDTO> Get(int id)
        {
            try
            {
        ...
        [LoggedIn("Manager")]
        [HttpPost]
        public ActionResult<RestaurantSectorDTO> Post([FromBody] RestaurantSectorDTO value)
        {
            try
            {
